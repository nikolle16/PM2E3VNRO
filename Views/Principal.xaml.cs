...
public partial class Principal : ContentPage
{
    ...
    public Principal(IAudioManager audioManager)
    {
        ...
        if (App.nota != null)
        {
            ...
            SetAudioButtonStyle("done_ico.png", Color.FromArgb("#807ad3be"));
        }
    }
    ...
    private async void OnBtnStartRecordingClicked(object sender, EventArgs e)
    {
        if (permiso == PermissionStatus.Granted)
        {
            if (!audioRecorder.IsRecording)
            {
                ...
                SetAudioButtonStyle("stop_ico.png", Color.FromArgb("#80ffbfaf"));
    ...
    private void LimpiarCampos()
    {
        ...
        SetAudioButtonStyle("micro.png", Color.FromArgb("#8071c55b"));
    }
}